...
function lost() {
 	window.location.assign("../HTML/imaze6.html");
}/*End of function*/
 

/*Win function below will assing the window location to go on to the next maze*/
function win() {
 	window.location.assign("../HTML/imaze7.html");
}/*End of function*/
...
/*Star of maze*/
newDiv(0,0,12,12,12);/*1*/ newDiv(0,0,12,12,60);/*2*/ newDiv(0,0,12,24,24);/*3*/

newDiv(0,0,12,24,72);/*4*/ newDiv(0,0,24,36,12);/*5*/ newDiv(0,0,12,36,60);/*6*/

newDiv(0,0,12,48,72);/*7*/ newDiv(0,0,12,60,60);/*8*/ newDiv(0,0,12,72,36);/*9*/ 

newDiv(0,0,12,72,72);/*10*/ 
/*End of horizontal walls*/

newDiv(0,12,0,0,36);/*11*/ newDiv(-12,72,0,0,48);/*12*/ newDiv(-72,12,0,12,24);/*13*/ 

newDiv(-12,72,0,12,60);/*14*/ newDiv(-72,48,0,24,12);/*15*/ newDiv(-48,48,0,24,36);/*16*/ 

newDiv(-48,36,0,48,24);/*17*/
