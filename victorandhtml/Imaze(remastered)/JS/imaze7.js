...
function win() {
 	window.location.assign("../HTML/iend.html");
}/*End of function*/
...
function mazeCollision() {
	...
	function winCollision() {
		if(square.style.top === '39vh' && square.style.left === '39vh') {
			win();
		}/*End of if statement*/		
	}/*End of function*/
...
/*Star of maze*/
newDiv(0,0,60,12,12);/*1*/ newDiv(0,0,48,24,24);/*2*/ newDiv(0,0,48,36,36);/*3*/

newDiv(0,0,36,48,36);/*4*/ newDiv(0,0,60,60,24);/*5*/ newDiv(0,0,60,72,12);/*6*/
/*End of horizontal walls*/

newDiv(0,60,0,12,12);/*7*/ newDiv(-60,12,0,12,72);/*8*/ newDiv(-12,36,0,24,24);/*9*/ 

newDiv(-36,12,0,36,36);/*10*/
