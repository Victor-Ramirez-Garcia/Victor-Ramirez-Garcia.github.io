...
function mazeCollision() {
	...
	function winCollision() {
		if(square.style.top === '75vh' && square.style.left === '84vh') {
			win();
		}/*End of if statement*/		
	}/*End of function*/
...
/*Star of maze*/
newDiv(0,0,36,12,36);/*1*/ newDiv(0,0,24,24,36);/*2*/ newDiv(0,0,36,36,24);/*3*/

newDiv(0,0,24,48,36);/*4*/ newDiv(0,0,24,60,24);/*5*/ newDiv(0,0,36,72,12);/*6*/

newDiv(0,0,12,72,72);/*7*/ 
/*End of horizontal walls*/

newDiv(0,72,0,0,12);/*8*/ newDiv(-72,48,0,12,24);/*9*/ newDiv(-48,12,0,12,36);/*10*/ 

newDiv(-12,60,0,12,72);/*11*/ newDiv(-60,12,0,24,60);/*12*/ newDiv(-12,36,0,48,60);/*13*/
