...
function win() {
 	window.location.assign("../HTML/imaze5.html");
}/*End of function*/
...
function mazeCollision() {
	...
	function winCollision() {
		if(square.style.top === '39vh' && square.style.left === '33vh') {
			win();
		}/*End of if statement*/		
	}/*End of function*/
...
/*Star of maze*/
newDiv(0,0,60,12,0);/*1*/ newDiv(0,0,12,12,72);/*2*/ newDiv(0,0,12,24,0);/*3*/

newDiv(0,0,60,24,24);/*4*/ newDiv(0,0,60,36,12);/*5*/ newDiv(0,0,24,48,24);/*6*/

newDiv(0,0,24,60,12);/*7*/ newDiv(0,0,36,60,48);/*8*/ newDiv(0,0,36,72,36);/*9*/ 
/*End of horizontal walls*/

newDiv(0,36,0,36,12);/*10*/ newDiv(-36,12,0,36,36);/*11*/ newDiv(-12,12,0,36,72);/*12*/ 

newDiv(-12,12,0,48,48);/*13*/ newDiv(-12,12,0,48,60);/*14*/ newDiv(-12,12,0,60,36);/*15*/ 

newDiv(-12,12,0,72,24);/*16*/
