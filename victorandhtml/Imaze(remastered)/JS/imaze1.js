...
function mazeCollision() {
	...
	function winCollision() {
		if(square.style.top === '9vh' && square.style.left === '39vh') {
			win();
		}/*End of if statement*/		
	}/*End of function*/
...
/*Star of maze*/
newDiv(0,0,24,12,24);/*1*/ newDiv(0,0,12,12,60);/*2*/ newDiv(0,0,48,24,12);/*3*/

newDiv(0,0,36,36,24);/*4*/ newDiv(0,0,12,48,72);/*5*/ newDiv(0,0,24,60,12);/*6*/

newDiv(0,0,24,60,60);/*7*/ newDiv(0,0,24,72,48);/*8*/ 
/*End of horizontal walls*/

newDiv(0,72,0,0,12);/*9*/ newDiv(-72,12,0,0,36);/*10*/ newDiv(-12,24,0,0,72);/*11*/ 

newDiv(-24,24,0,24,60);/*12*/ newDiv(-24,12,0,36,24);/*13*/ newDiv(-12,36,0,36,48);/*14*/

newDiv(-36,12,0,36,72);/*15*/ newDiv(-12,24,0,48,36);/*16*/ newDiv(-24,12,0,72,24);/*17*/
