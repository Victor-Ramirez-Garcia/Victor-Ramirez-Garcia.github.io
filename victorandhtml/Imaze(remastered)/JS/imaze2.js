...
function lost() {
 	window.location.assign("../HTML/imaze2.html");
}/*End of function*/
...
function mazeCollision() {
	...
	function winCollision() {
		if(square.style.top === '69vh' && square.style.left === '69vh') {
			win();
		}/*End of if statement*/		
	}/*End of function*/
...
/*Star of maze*/
newDiv(0,0,12,12,0);/*1*/ newDiv(0,0,24,12,24);/*2*/ newDiv(0,0,24,12,60);/*3*/

newDiv(0,0,60,24,12);/*4*/ newDiv(0,0,12,36,24);/*5*/ newDiv(0,0,12,36,48);/*6*/

newDiv(0,0,72,48,12);/*7*/ newDiv(0,0,12,60,24);/*8*/ newDiv(0,0,24,60,48);/*9*/ 

newDiv(0,0,12,72,60);/*10*/ 
/*End of horizontal walls*/

newDiv(0,12,0,0,24);/*11*/ newDiv(-12,48,0,24,12);/*12*/ newDiv(-48,12,0,24,36);/*13*/ 

newDiv(-12,12,0,24,60);/*14*/ newDiv(-12,12,0,36,72);/*15*/ newDiv(-12,24,0,48,36);/*16*/ 

newDiv(-24,24,0,60,48);/*17*/ newDiv(-24,12,0,60,72);/*18*/ newDiv(-12,12,0,72,24);/*19*/
