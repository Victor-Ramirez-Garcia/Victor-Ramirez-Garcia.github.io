...
function lost() {
 	window.location.assign("../HTML/iexample.html");
}/*End of function*/
 

/*Win function below will assing the window location to go on to the next maze*/
function win() {
 	window.location.assign("../HTML/imaze1.html");
}/*End of function*/
...
function mazeCollision() {
	...
	function winCollision() {
		if(square.style.top === '84vh' && square.style.left === '84vh') {
			win();
		}/*End of if statement*/		
	}/*End of function*/
...
/*Start of maze*/
newDiv(0,0,12,12,0);/*1*/ newDiv(0,0,12,12,24);/*2*/ newDiv(0,0,24,12,48);/*3*/

newDiv(0,0,12,24,12);/*4*/ newDiv(0,0,12,24,60);/*5*/ newDiv(0,0,24,36,0);/*6*/

newDiv(0,0,24,36,36);/*7*/ newDiv(0,0,12,36,72);/*8*/ newDiv(0,0,18,48,6);/*9*/

newDiv(0,0,24,48,48);/*10*/ newDiv(0,0,12,60,24);/*11*/ newDiv(0,0,9,60,54);/*12*/

newDiv(0,0,33,72,24);/*13*/ newDiv(0,0,12,72,72);/*14*/ newDiv(0,0,18,81,6);/*15*/

newDiv(0,0,9,81,54);/*16*/ newDiv(0,0,15,81,69);/*17*/ 
/*End of horizontal walls*/

newDiv(0,24,0,0,24);/*18*/

newDiv(-24,12,0,12,36);/*19*/ newDiv(-12,12,0,12,48);/*20*/ newDiv(-12,12,0,12,72);/*21*/

newDiv(-12,12,0,24,60);/*22*/ newDiv(-12,24,0,36,36);/*23*/ newDiv(-24,12,0,48,24);/*24*/

newDiv(-12,33,0,48,6);/*25*/ newDiv(-33,9,0,72,24);/*26*/ newDiv(-9,33,0,48,48);/*27*/

newDiv(-33,24,0,48,72);/*28*/ newDiv(-24,24,0,60,63);/*29*/ newDiv(-24,6,0,78,36);/*30*/
