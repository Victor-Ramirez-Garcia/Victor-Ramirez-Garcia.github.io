...
function changes() {
  setTimeout(function() {
    document.getElementById('mainForm').action = "animation3.html";
  }, 1000);//in 1 second the form will change action from #mainForm to animation2.html

  setTimeout(function() {
    document.getElementById('mainForm').action = 'index.html';
  }, 2200);//in 2.2 seconds, the mainForm will change action from animation2.html to nothing
}
